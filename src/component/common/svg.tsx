...
export function XMark({ className, size = "size-6", ...props }: IconProps) {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={classes(size, "text-black cursor-pointer", className)}
      {...props}
    >
      <path
        strokeLinecap="round"
...
export function Eye({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={classes("size-6", className)}
      {...props}
    >
      <path
        strokeLinecap="round"
...
export function EyeSlash({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Search({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={classes("size-8", className)}
      {...props}
    >
      <path
        strokeLinecap="round"
